...
PATH_TO_SAVE_IMAGES_DIR = '/home/lserra/Work/Serving/output_folder/cctv'

# path to archive processed images
#PATH_TO_ARCHIVE = '/home/lserra/Work/tensorflow/cctv/archive_folder'

# List of strings that is used to add correct label for each box.
PATH_TO_LABELS = '/home/lserra/Work/tensorflow/models/research' \
...
# don't think so because we still need to put the bounding boxes on the pictures
